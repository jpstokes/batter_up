...
describe 'player' do
  ...
  describe '#find_players_by_team_and_year' do
    before do
      ...
      FactoryGirl.create(:statistic, :player_id => 2, :team_id => 'panthers', :year_id => 2003)
      FactoryGirl.create(:statistic, :player_id => 2, :team_id => 'dolphins', :year_id => 2007)
    end

    context 'when team and year match' do
      it 'returns all matching players' do
        expect(Player.find_players_by_team_and_year('panthers', 2003).count).to eq(2)
      end
    end

    context 'when team does not match' do
      it 'does not return player' do
        expect(Player.find_players_by_team_and_year('titans', 2003).count).to eq(0)
      end
    end

    context 'when year does not match' do
      it 'does not return player' do
        expect(Player.find_players_by_team_and_year('panthers', 2001).count).to eq(0)
      end
    end
  end
  ...
  describe '#highest_batting_average' do
    before do
      @player_1 = FactoryGirl.create(:player, :player_id => 3, :first_name => 'James')
      @player_2 = FactoryGirl.create(:player, :player_id => 4, :first_name => 'Joseph')
      @player_3 = FactoryGirl.create(:player, :player_id => 5, :first_name => 'Jude')

      FactoryGirl.create(:statistic, :player_id => 3, :hits => 20, :at_bat => 30, :year_id => 2000)
      FactoryGirl.create(:statistic, :player_id => 4, :hits => 25, :at_bat => 30, :year_id => 2000)
      FactoryGirl.create(:statistic, :player_id => 5, :hits => 28, :at_bat => 30, :year_id => 2000)
    end

    it 'chooses the player with the highest batting average' do
      expect(Player.highest_batting_average([@player_1, @player_2, @player_3], 2000).first_name).to eq('Jude')
    end
  end
  ...
  describe '#most_home_runs' do
    before do
      ...
      FactoryGirl.create(:statistic, :player_id => 3, :home_runs => 20, :at_bat => 30, :year_id => 2000)
      FactoryGirl.create(:statistic, :player_id => 4, :home_runs => 25, :at_bat => 30, :year_id => 2000)
      FactoryGirl.create(:statistic, :player_id => 5, :home_runs => 28, :at_bat => 30, :year_id => 2000)
    end

    it 'chooses the player with the highest batting average' do
      expect(Player.most_home_runs([@player_1, @player_2, @player_3], 2000).first_name).to eq('Jude')
    end
  end
  ...
  describe '#most_rbi' do
    before do
      ...
      FactoryGirl.create(:statistic, :player_id => 3, :runs_batted_in => 20, :at_bat => 30, :year_id => 2000)
      FactoryGirl.create(:statistic, :player_id => 4, :runs_batted_in => 25, :at_bat => 30, :year_id => 2000)
      FactoryGirl.create(:statistic, :player_id => 5, :runs_batted_in => 28, :at_bat => 30, :year_id => 2000)
    end

    it 'chooses the player with the highest batting average' do
      expect(Player.most_rbi([@player_1, @player_2, @player_3], 2000).first_name).to eq('Jude')
    end
  end
